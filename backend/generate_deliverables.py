"""
Generates the redacted DOCX file for the assignment deliverables.
"""
import sys
sys.path.insert(0, '.')
...
from app.services.docx_processor import create_redacted_docx
...
print("Creating original resume DOCX...")
doc = Document()
...
with open("original_resume.docx", "wb") as f:
...
print("Generating redacted DOCX...")
...
redacted_bytes = create_redacted_docx(original_bytes, pii_entities)

with open("../redacted_resume.docx", "wb") as f:
    f.write(redacted_bytes)

print("Saved to ../redacted_resume.docx")
